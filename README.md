...
* 取得一個 list 只有 name，且不重複並排序的資料   http://localhost:8080/stream/user/getAllName
  * EX:[Bill, Brian, KZ]  

* 取得一個 map，其 key 為 ID；value 為 name   http://localhost:8080/stream/user/getMapAndIdName
  *  EX:1 : “Bill”   
...
* 取得一個 string 為所有資料的 name, age|name, age   http://localhost:8080/stream/user/getAllByStringNameAndAge
  *  EX:Bill, 13|KZ, 23   
